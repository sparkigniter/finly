...
class FinAdvisorStocksAgent:
    ...
    _model: str = "gemini-3.1-pro-preview"
    _agent: Optional[Agent] = None
    _name: str = "financial_advisor_agent"
    config: Optional[FinAdvisorStocksConfig] = None

    def __init__(self, config: Optional[FinAdvisorStocksConfig] = None):
        """Initializes a new instance of the class."""
        self.config = config or FinAdvisorStocksConfig()
        self._create_agent()
    ...
    def _create_agent(self) -> Agent:
        ...
        FinAdvisorStocksAgent._agent = agent
        return agent

    def agent(self) -> Agent:
        """Provides access to the Agent instance."""
        return FinAdvisorStocksAgent._agent
